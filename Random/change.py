...
##
##def storage ():
##    #1 get user input from user find out how much change
##    total_change = float(input("How much change do you have in your pocket? "))
...
##    print("Quarters:",q,"\nDimes:",d,"\inNickles:",n,"\inPennies:",p)
##storage()
