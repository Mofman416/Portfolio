...
class Board(object):
    ...
    def displayboard(self):
        ...
        print("|  " + p3p[50] + p4p[50] + "  |  " + p3p[51] + p4p[51] + "  |  " + p3p[52] + p4p[52] + "  |  " + p3p[53]
              ...
              "  |  " + p3p[57] + p4p[57] + "  |  " + p3p[58] + p4p[58] + "  |   " + p3p[59] + p4p[59] + "  | ")
        print("------------------------------------------------------------------------")
        print("|50" + p1p[49] + p2p[49] + "  |49" + p1p[48] + p2p[48] + "  |48" + p1p[47] + p2p[47] + "  |47" + p1p[46]
              + p2p[46] + "  |46" + p1p[45] + p2p[45] + "  |45" + p1p[44] + p2p[44] + "  |44" + p1p[43] + p2p[43] +
              "  |43" + p1p[42] + p2p[42] + "  |42" + p1p[41] + p2p[41] + "  | 41" + p1p[40] + p2p[40] + "  | ")
        print("|  " + p3p[49] + p4p[49] + "  |  " + p3p[48] + p4p[48] + "  |  " + p3p[47] + p4p[47] + "  |  " + p3p[46]
              + p4p[46] + "  |  " + p3p[45] + p4p[45] + "  |  " + p3p[44] + p4p[44] + "  |  " + p3p[43] + p4p[43] +
              "  |  " + p3p[42] + p4p[42] + "  |  " + p3p[41] + p4p[41] + "  |   " + p3p[40] + p4p[40] + "  | ")
        print("------------------------------------------------------------------------")
        print("|31" + p1p[30] + p2p[30] + "  |32" + p1p[31] + p2p[31] + "  |33" + p1p[32] + p2p[32] + "  |34" + p1p[33]
              + p2p[33] + "  |35" + p1p[34] + p2p[34] + "  |36" + p1p[35] + p2p[35] + "  |37" + p1p[36] + p2p[36] +
              "  |38" + p1p[37] + p2p[37] + "  |39" + p1p[38] + p2p[38] + "  | 40" + p1p[39] + p2p[39] + "  | ")
        print("|  " + p3p[30] + p4p[30] + "  |  " + p3p[31] + p4p[31] + "  |  " + p3p[32] + p4p[32] + "  |  " + p3p[33]
...
def main():
    ...
    while not winner:
        print(players[turn].name + " piece " + players[turn].token + " it's your turn.")
